...
class IR18(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.feature = timm.create_model(model_name="resnet18",
                                         num_classes=0,
                                         pretrained=True)
        self.feat_dim = self.feature.num_features
        self.num_classes = num_classes
        self.fc_layer = nn.Linear(self.feat_dim, self.num_classes)
...
class IR18_grey(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.feature = timm.create_model(model_name="resnet18",
                                         num_classes=0,
                                         pretrained=True)
        self.feature.conv1 = nn.Conv2d(1, 64, stride=2, kernel_size=7, padding=3, bias=False)
        self.feat_dim = self.feature.num_features
        self.num_classes = num_classes
        self.fc_layer = nn.Linear(self.feat_dim, self.num_classes)
...
class IR34(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.feature = timm.create_model(model_name="resnet34",
                                            num_classes=0,
                                            pretrained=True)
        self.feat_dim = self.feature.num_features
        self.num_classes = num_classes
...
class IR50(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.feature = timm.create_model(model_name="resnet50",
                                         num_classes=0,
                                         pretrained=True)
        self.feat_dim = self.feature.num_features
        self.num_classes = num_classes
...
class conv3(nn.Module):
    def __init__(self, num_classes=5):
        ...
        self.conv2 = nn.Conv2d(10, 20, kernel_size=9)
        self.conv2_drop = nn.Dropout2d()
